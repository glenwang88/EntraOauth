...
export const Configurations = () => {
    ...
    const [authority, setAuthority] = useState('https://[tenant_name].ciamlogin.com/');
    ...
    const handleSave = (event) => {
        try {
            ...
            localStorage.setItem('ciamMsalConfig', JSON.stringify({
                auth: {
                    clientId: clientId,
                    authority: authority
                },
            ...
            localStorage.setItem('ciamLoginRequest', JSON.stringify({
                    scopes: scopes.split(' '),
    ...
    return (
            ...
            <Card className="bg-light" style={{ marginTop: '40px', marginBottom: '40px'  }}>
                ...
                <Card.Header> OAuth Configuration Form - CIAM</Card.Header>
                <Card.Body>
                            ...
                            <Form.Label column sm="2">Authority: <span style={{ color: 'red' }}>*</span> 
                                <OverlayTrigger
                                    ...
                                    overlay={
                                        ...
                                        Replace [tenant_name] with your tenant name in https://[tenant_name].ciamlogin.com.
                                        </Tooltip>
                                    }
                                >
                                    <span>
